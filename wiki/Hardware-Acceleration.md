...
- H.264 (h264_amf)
- H.265/HEVC (hevc_amf)
- AV1 (av1_amf) - RX 7000 series only
...
- H.264 (h264_qsv)
- H.265/HEVC (hevc_qsv)
- AV1 (av1_qsv) - Arc GPUs and 11th gen+ iGPUs
...
For example:
- "Balanced" preset uses h264_nvenc on NVIDIA GPUs
- Same preset uses h264_amf on AMD GPUs
...
*Note: Actual performance varies by GPU model, CPU, and content complexity*
...
*Percentages are approximate and vary by content*
...
- Compare quality with [Video Comparison](Video-Comparison.md) tool
- Measure performance with [Quality Analysis](Quality-Analysis.md)
- Optimize workflows in [Advanced Usage](Advanced-Usage.md)
- Create hardware-specific [Custom Presets](Custom-Presets.md)
