...
Use [Quality Analysis](Quality-Analysis.md) to measure:
...
To customize:
1. Use [Advanced Settings](Advanced-Usage.md) to override
2. Create a [Custom Preset](Custom-Presets.md) based on built-in preset
...
**Solutions**:
- Use [Quality Analysis](Quality-Analysis.md) to verify
- Adjust CRF in [Advanced Settings](Advanced-Usage.md)
...
3. Create [Custom Preset](Custom-Presets.md) with lower CRF

## Next Steps

- Create [Custom Presets](Custom-Presets.md) for specific needs
- Learn about [Advanced Usage](Advanced-Usage.md) to override preset settings
- Use [Quality Analysis](Quality-Analysis.md) to compare presets
